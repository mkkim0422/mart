...
- **실제 코드**: 커밋 `987a26b`에서 `widget/actions/CheckItemAction.kt`(36줄)와 단일 `GroceryWidget.kt`(259줄) **삭제됨**. 현재 `widget/actions/`에는 `OpenStoreAction.kt`만 존재. `WidgetItemRow.kt` 주석: _"Simple read-only row"_ — 탭 시 앱만 열림.
