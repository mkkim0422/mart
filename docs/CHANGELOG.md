...
- 2026-06-14 · 스와이프 탭/필터 전환 애니메이션 개선: 좌우 슬라이드(바디만 밀려 탭과 따로 노는 어색함) 제거하고 220ms 크로스페이드(tween, FastOutSlowInEasing)만 사용 · `ui/screens/home/HomeScreen.kt`, `ui/screens/completed/CompletedScreen.kt`
